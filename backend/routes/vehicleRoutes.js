...
router.post(
  ...
  body('vehicle_type').isIn(['Sedan', 'SUV', 'Hatchback', 'Van', 'Truck', 'Bike', 'Car', 'Premium', 'Motorcycle', 'Rickshaw']),
...
router.put(
  ...
  authMiddleware,
  param('id').isInt().toInt(),
  body('vehicle_type').optional().isIn(['Sedan', 'SUV', 'Hatchback', 'Van', 'Truck', 'Bike', 'Car', 'Premium', 'Motorcycle', 'Rickshaw']),
...
router.get(
  ...
  query('vehicle_type').optional().isIn(['Sedan', 'SUV', 'Hatchback', 'Van', 'Truck', 'Bike', 'Car', 'Premium', 'Motorcycle', 'Rickshaw']),
  query('limit').optional().isInt({ min: 1, max: 100 }).toInt(),
  query('offset').optional().isInt({ min: 0 }).toInt(),
